...
public class GetAllStudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_getallstudents);
        new Students().execute("hii");
    }
    private void showdetails(JSONObject jsonObject) {
        TableLayout tableLayout = findViewById(R.id.students);
        ...
        try {
            ...
            for(int i = 0; i < jsondata.length(); i++){
                ...
                textView_dept.setText(object.get("department").toString());
            ...
            Toast.makeText(GetAllStudents.this,
